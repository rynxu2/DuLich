...
const styles = StyleSheet.create({
  ...
  filterRow: { flexDirection: 'row', paddingHorizontal: 20, paddingTop: 12, paddingBottom: 16, gap: 8 },
  filterTab: {
  ...
  filterTabText: { fontSize: 13, color: theme.colors.textSecondary, fontWeight: '600' },
  filterTabTextActive: { color: '#fff', fontWeight: '700' },

  list: { paddingHorizontal: 20, paddingBottom: 100 },
  
  card: {
    backgroundColor: theme.colors.surface, borderRadius: 20, marginBottom: 20,
    ...theme.shadows.lg,
  },
  cardImageContainer: { height: 150, width: '100%', borderTopLeftRadius: 20, borderTopRightRadius: 20, overflow: 'hidden' },
  cardImage: { width: '100%', height: '100%' },
  cardOverlay: { position: 'absolute', top: 0, bottom: 0, left: 0, right: 0, backgroundColor: 'rgba(0,0,0,0.15)' },
  badge: {
  ...
  tourName: { fontSize: 18, fontWeight: '700', color: theme.colors.text, marginBottom: 10, lineHeight: 24, letterSpacing: -0.2 },
  ...
  ticketNotchLeft: { width: 12, height: 24, backgroundColor: theme.colors.background, borderTopRightRadius: 12, borderBottomRightRadius: 12 },
  ticketNotchRight: { width: 12, height: 24, backgroundColor: theme.colors.background, borderTopLeftRadius: 12, borderBottomLeftRadius: 12 },
  ...
  priceLabel: { fontSize: 11, fontWeight: '600', color: theme.colors.textSecondary, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2 },
  price: { fontSize: 22, fontWeight: '800', color: theme.colors.accent },
  paymentStatusBadge: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10 },
  paymentStatusText: { fontSize: 12, fontWeight: '700' },

  actionsRow: { flexDirection: 'row', justifyContent: 'flex-end', gap: 10 },
  btnOutline: {
    paddingHorizontal: 18, paddingVertical: 10,
    borderRadius: theme.borderRadius.xl, borderWidth: 1.5, borderColor: theme.colors.border, alignItems: 'center',
  },
  btnOutlineText: { fontSize: 13, fontWeight: '600', color: theme.colors.textSecondary },
  btnPrimary: {
    paddingHorizontal: 18, paddingVertical: 10,
    borderRadius: theme.borderRadius.xl, backgroundColor: theme.colors.primary, alignItems: 'center',
  ...
  emptySubtitle: { fontSize: 14, color: theme.colors.textSecondary, textAlign: 'center', paddingHorizontal: 40, lineHeight: 21, marginBottom: 24 },
  exploreBtn: {
    paddingHorizontal: 28, paddingVertical: 14, borderRadius: theme.borderRadius.xl,
    backgroundColor: theme.colors.primary,
    ...theme.shadows.colored,
  },
